...
function TankForm({ initial, customers, onDone }: { initial?: Tank; customers: Customer[]; onDone: () => void }) {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const body = { name: form.get('name'), location: form.get('location'), description: form.get('description') || null, is_public: form.get('is_public') === 'on', customer_id: customer ? Number(customer) : null, feeding_schedule: form.get('feeding_schedule') || null, public_care_notes: form.get('public_care_notes') || null, tank_code: form.get('tank_code') || null, habitat_label: form.get('habitat_label') || null, water_type: form.get('water_type') || null, volume_liters: volume ? Number(volume) : null, established_on: form.get('established_on') || null, hero_image_url: form.get('hero_image_url') || null };
